...
\setDocChangeRecord{%
  ...
  \addtohist{4}{2022-11-21}{Updated post DP0.2 release.}{Melissa Graham}
}
...
\subsection{DP0.2 Allocations}\label{ssec:sel_dp02_allocated}

For DP0.2, there were 197 applicants with data rights from 23 unique countries, with the top four USA (35\%), Italy (16\%), the UK (8\%), and Chile (8\%), and all remaining countries with $<$5\%.
Since applications were not oversubscribed for DP0.2, there was no selection process applied, and all applicants were invited to become delegates and participate in DP0.2.
...
The Delegate Groups also provide some insight into the demographics of the DP0.2 applicants.
