...
Further details about capability differences can be found in \citeds{RTN-001}, and will be clarified in the DP0 documentation.
...
A key component of Rubin Observatory's Community Engagement Model \citedsp{rtn-006} is to build a self-sustaining LSST science community that is able to crowd-source solutions. 
Ensuring diversity among the DP0 delegates is key to seeding the distributed expertise that will be the foundation of this community: a network of users from a variety of global locations, institutional types, career stages, and astronomical fields, and which which includes representatives of groups that are underrepresented in astronomy.
